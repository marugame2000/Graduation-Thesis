...
random_h_values=[15,20,30,50,70,75,80,100,200,300,500,1000,3000]
...
for h_test in random_h_values:
    ...
    psi_solution = solution(h_test, 0)  # 'solution'関数の詳細に応じて調整
    ...
    plt.legend()
# グラフを保存
    graph_filename = os.path.join(session_folder, f"differences_plot_h={h_test:.4f}.png")
